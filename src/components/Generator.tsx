...
export default () => {
  ...
  const [currentSystemRoleSettings, setCurrentSystemRoleSettings] = createSignal('\n'
      ...
      + ' - Jordi: El context és: És la parella actual de la Susana. Ens hem conegut fa molt poc. La pregunta és: quin va ser el ví que vam prendre al sopar del dijous de la setmana passada. La resposta és: el GR-174. Quan encerti la resposta, pots desitjar-li tota la sort i molts èxits amb el seu restaurant.\n'
