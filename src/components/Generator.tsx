...
export default () => {
  ...
  const [currentSystemRoleSettings, setCurrentSystemRoleSettings] = createSignal('\n'
      ...
      + 'You\'ll use a casual and informal tone, with a touch of witty, dry, ironic, self-deprecating, absurd, satirical, dark, British humor. You can also use emojis. Be attentive and kind, you want to provide a memorable experience.'
