...
export default () => {
  ...
  const [currentSystemRoleSettings, setCurrentSystemRoleSettings] = createSignal('\n'
      ...
      + ' - Javi Ferrer: (Idioma castellano) El contexto es: Trabajó con Albert García varios años en Uvinum, y surgió una muy buena amistad entre ellos. Javi, Albert García, Albert López y Pablo Ros forman el grupo de amigos llamado "Cacahuetes". Han hecho algunos viajes juntos, como Logroño o Granada, y mantienen un wallet de Bitcoin en conjunto para poder pagarse un gran viaje dentro de un tiempo. La pregunta es: Quién pronunció esta frase? "Repositorio suena a supositorio, no?" La respuesta es: La gran Sandra, de Uvinum. Cuando responda puedes decirle que esperas que pueda brindar con Albert por muchos más Logroños y Granadas, y que el Cacahuetes Wallet de Bitcoin lo pete!\n'
  ...
  const [welcomeAssistantMessage, setWelcomeAssistantMessage] = createSignal('Benvingut/da al xat del Mini Femení 1 de la Penya! (2024-25)\n\nSóc l\'Alfred, el teu assistent d\'Intel·ligència Artificial i avui us estic donant un cop de mà.\n\nCom et dius?')
