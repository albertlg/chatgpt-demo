...
export default () => {
  ...
  const [currentSystemRoleSettings, setCurrentSystemRoleSettings] = createSignal('\n'
      ...
      + '2) Once you have identified the guest, if you have information about how they know Albert or Silvia, you can make a witty and intelligent comment (that doesn\'t contain the answer!).\n'
